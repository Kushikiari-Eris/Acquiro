...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased ">
        <div class=" sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter selection:bg-red-500 selection:text-white">
            @if (Route::has('login'))
                
                    <nav class="border-gray-200 dark:border-gray-700 sticky top-0 z-50 bg-white bg-opacity-90 dark:bg-gray-900 dark:bg-opacity-90 backdrop-blur-md">
                    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                      
                        <img src="{{ asset('image/logoko.png') }}" class="h-[7vh]">
                      ...
                      <div class="hidden w-full md:block py-5 md:w-auto" id="navbar-default">
                        <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-transparent dark:border-gray-700">
                          ...
                          <li>
                            <a href="#advocacy" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Advocacy</a>
                          </li>
                          <li>
                            <a href="#charities" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Charities</a>
                          </li>
                          <li>
                            <a href="#donators" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Donators</a>
                          </li>
                          <li>
                          ...
                          <li>
                            <a href="#partners" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Partners</a>
                          </li>
                          <li>
                          ...
                          <li>
                            @auth
                            <a href="{{ url('/home') }}" class="text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparen">Dashboard</a>
                            @else
                            <a href="{{ route('login') }}" class="ml-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500  dark:hover:text-white md:dark:hover:bg-transparen">Log in</a>
                            @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:text-white md:dark:hover:bg-transparen">Register</a>
                            @endif
                            @endauth
                          </li>
                        </ul>
                ...
                <section class="bg-white dark:bg-gray-900 relative" id="home">
                    <img src="https://businessweekmindanao.com/wp-content/uploads/2023/01/ACQ-PR-KV.png" alt="Image" class="w-full h-auto">
                    <div class="absolute inset-0 flex items-center justify-center top-[20vh]">
                        <button class="bg-green-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-700 md:py-3 md:px-6 lg:py-4 lg:px-8 text-sm md:text-base lg:text-lg">
                            @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="">Interested?</a>
                            @endif
                        </button>
                    </div>
                </section>
            ...
            <section class="bg-white dark:bg-gray-900 bg-dots-darker bg-center dark:bg-dots-lighter"  id="advocacy">
                <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
                  ...
                  <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                    ...
                    <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Goals and Objectives</h2>
                    <p class="mb-4">Helping others comes in all forms and shapes; from volunteering at a homeless shelter, sponsoring an event, fundraising for a charity, donating money to a good cause, helping a friend or family member out to a random act of kindness for a stranger.</p>
                    
                  </div>
                  <div class="grid grid-cols-2 gap-4 mt-8">
                    <img class="w-full rounded-lg" src="https://media.istockphoto.com/id/1353332258/photo/donation-concept-the-volunteer-giving-a-donate-box-to-the-recipient-standing-against-the-wall.jpg?s=2048x2048&w=is&k=20&c=8JFKSGTW3M-rZA3nrLPnhI0TjjQOFRgipg6df0pF7kA=">
                    <img class="mt-4 w-full lg:mt-10 rounded-lg" src="https://cdn.pixabay.com/photo/2017/05/30/07/05/social-work-2356009_1280.jpg">
                  </div>
                </div>
              </section>
            
              <section class="bg-white dark:bg-gray-900 bg-dots-darker bg-center dark:bg-dots-lighter" id="charities">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <h2 class="font-manrope text-4xl font-bold text-gray-900 text-center mb-16  tracking-tight  dark:text-white">Charities</h2>
                    <div class="flex justify-center  gap-y-8 lg:gap-y-0 flex-wrap md:flex-wrap lg:flex-nowrap lg:flex-row lg:justify-between lg:gap-x-8">
                       <div class="group w-full max-lg:max-w-xl lg:w-1/3 border border-gray-300 rounded-2xl">
                        <div class="flex items-center">
                            <img src="https://cdn.pixabay.com/photo/2013/02/16/16/00/children-82272_1280.jpg" class="rounded-t-2xl w-full">
                        </div>
                        <div class="p-4 lg:p-6 transition-all duration-300 rounded-b-2xl group-hover:bg-gray-50">
                            <span class="text-indigo-600 font-medium mb-3 block">Children</span>
                            <h4 class="text-xl text-gray-500 font-medium leading-8 mb-5">Save the Children</h4>
                            <p class="text-gray-500 leading-6 mb-10">Save the Children, the world’s leading independent children’s organization, has been working in the Philippines for over four decades and is dedicated to transforming children’s lives and the future we share.</p>
                            <a href="https://www.savethechildren.org.ph/" class="cursor-pointer text-lg text-indigo-600 font-semibold">Read more..</a>
                        </div>
                       </div>
                       <div class="group w-full max-lg:max-w-xl lg:w-1/3 border border-gray-300 rounded-2xl">
                        <div class="flex items-center">
                            <img src="https://cdn.pixabay.com/photo/2016/01/01/02/01/animal-welfare-1116203_1280.jpg" class="rounded-t-2xl w-full">
                        </div>
                        <div class="p-4 lg:p-6 transition-all duration-300 rounded-b-2xl group-hover:bg-gray-50">
                            <span class="text-indigo-600 font-medium mb-3 block">Animals</span>
                            <h4 class="text-xl text-gray-500 font-medium leading-8 mb-5">Pawssion project</h4>
                            <p class="text-gray-500 leading-6 mb-10">Our sheltes serve as a home to atleast 600 rescues who were once homeless, abused, neglected, and on deathrow. We have 2shelters in the Philippines Come see the rescues that inspire us to keep fighting for the voiceless.</p>
                            <a href="https://pawssionproject.org.ph/" class="cursor-pointer text-lg text-indigo-600 font-semibold">Read more..</a>
                        </div>
                       </div>
                       <div class="group w-full max-lg:max-w-xl lg:w-1/3 border border-gray-300 rounded-2xl">
                        <div class="flex items-center">
                            <img src="https://cdn.pixabay.com/photo/2018/04/27/21/39/earth-3355931_1280.jpg" class="rounded-t-2xl w-full">
                        </div>
                        <div class="p-4 lg:p-6 transition-all duration-300 rounded-b-2xl group-hover:bg-gray-50">
                            <span class="text-indigo-600 font-medium mb-3 block">Agriculture</span>
                            <h4 class="text-xl text-gray-500 font-medium leading-8 mb-5">Growing Hope</h4>
                            <p class="text-gray-500 leading-6 mb-10">We already knew from our experience with feeding programs that many Filipinos were not getting enough to eat. Ironically, farmers–those who grow food for others–were suffering from gross food insecurity.</p>
                            <a href="https://www.nvcfoundation-ph.org/growing-hope/" class="cursor-pointer text-lg text-indigo-600 font-semibold">Read more..</a>
                        </div>
                       </div>
                    </div>
                  </div>
              ...
              <section class="bg-white dark:bg-gray-900 bg-dots-darker bg-center dark:bg-dots-lighter" id="donators" >
                <div id="map-container" class="dark:bg-gray-900 grid grid-rows-3 grid-flow-col gap-4 py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
                    <div id="worldmap" class="row-span-3 overflow-x-auto" style="min-height: 30rem; min-width: 50rem"></div>
                    <div class="row-span-2 col-span-2">
                        <p class=" font-manrope text-4xl font-bold text-yellow-500 text-center mb-5  tracking-tight dark:text-yellow-500 flex justify-center">Top Donators</p>
                        <p class=" font-manrope text-4xl font-bold text-white text-center  tracking-tight dark:text-white flex justify-start"><img src="{{ asset('image/1st.png')}}" class="">Bill Gates</p>
                        <p class=" font-manrope text-4xl font-bold text-white text-center  tracking-tight dark:text-white flex justify-start"><img src="{{ asset('image/2nd.png')}}" class="">Elon Musk</p>
                        <p class=" font-manrope text-4xl font-bold text-white text-center  tracking-tight dark:text-white flex justify-start"><img src="{{ asset('image/3rd.png')}}" class="">Mark Zuckerberg</p>
                        <p class=" font-manrope text-4xl font-bold text-purple-700 text-center mb-5  tracking-tight dark:text-purple-700 flex justify-center">Top Points Donators</p>
                        <p class=" font-manrope text-4xl font-bold text-white text-center  tracking-tight dark:text-white flex justify-start"><img src="{{ asset('image/1st.png')}}" class="">Diwata</p>
                        <p class=" font-manrope text-4xl font-bold text-white text-center  tracking-tight dark:text-white flex justify-start"><img src="{{ asset('image/2nd.png')}}" class="">Princess</p>
                        <p class=" font-manrope text-4xl font-bold text-white text-center  tracking-tight dark:text-white flex justify-start"><img src="{{ asset('image/3rd.png')}}" class="">Diyata</p>
                    </div>
                  </div>
              </section>
              ...
              <section class="bg-white dark:bg-gray-900 bg-dots-darker bg-center dark:bg-dots-lighter" id="team">
                <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
                    <div class="mx-auto mb-8 max-w-screen-sm lg:mb-16">
                        <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Our team</h2>
                        <p class="font-light text-gray-500 sm:text-xl dark:text-gray-400">“Coming together is a beginning; keeping together is progress; working together is success.”</p>
                    </div> 
                    <div class="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                        ...
                        <div class="text-center text-gray-500 dark:text-gray-400">
                            <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="{{asset('image/alan.jpg')}}">
                            <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                                <a href="#">Alan Jules Bongon</a>
                            </h3>
                            <p>Planner</p>
                            <ul class="flex justify-center mt-4 space-x-4">
                                <li>
                        ...
                        <div class="text-center text-gray-500 dark:text-gray-400">
                            <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="{{asset('image/castilo.jpg')}}">
                            <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                                <a href="#">Jerome Castillo</a>
                            </h3>
                            <p>Marketing</p>
                            <ul class="flex justify-center mt-4 space-x-4">
                                <li>
                        ...
                        <div class="text-center text-gray-500 dark:text-gray-400">
                            <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="{{asset('image/eris.jpg')}}">
                            <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                                <a href="#">Eris Hally Pena</a>
                            </h3>
                            <p>Developer</p>
                            <ul class="flex justify-center mt-4 space-x-4">
                                <li>
                        ...
                        <div class="text-center text-gray-500 dark:text-gray-400">
                            <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="{{asset('image/patrick.jpg')}}">
                            <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                                <a href="#">Patrick Bueno</a>
                            </h3>
                            <p>Designer</p>
                            <ul class="flex justify-center mt-4 space-x-4">
                                <li>
              ...
              <section class="bg-white dark:bg-gray-900 bg-dots-darker bg-center dark:bg-dots-lighter" id="partners">
                <div class="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
                    <h2 class="mb-8 lg:mb-16 text-3xl font-extrabold tracking-tight leading-tight text-center text-gray-900 dark:text-white md:text-4xl">Partners</h2>
              ...
              <section class="bg-white dark:bg-gray-900 bg-dots-darker bg-center dark:bg-dots-lighter" id="contact">
